...
_experiments = [
    Experiment(
        ...
        "--wandb_user=multi-drones --wandb_project=zh-reward-decrease --wandb_tags mujoco hopper 0b7c22ca4de0d5fc7f4f79e76afbfc7ef67ddd87 "
...
# python -m sample_factory.runner.run --run=sample_factory_examples.mujoco_examples.mujoco_hopper --runner=processes --max_parallel=4  --pause_between=1 --experiments_per_gpu=10000 --num_gpus=1 --experiment_suffix=4
