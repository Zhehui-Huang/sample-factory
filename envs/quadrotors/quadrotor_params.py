...
def add_quadrotors_env_args(env, parser):
    ...
    p.add_argument('--quads_local_coeff', default=1.0, type=float, help='This parameter is used for the metric of select which drones are the N closest drones.')
    p.add_argument('--quads_local_metric', default='dist', type=str, choices=['dist', 'dist_inverse'], help='The main part of evaluate the closest drones')
