...
def make_quadrotor_env_multi(cfg, **kwargs):
    ...
    env = QuadrotorEnvMulti(
        ...
        quads_mode=cfg.quads_mode, swarm_obs=extended_obs, quads_use_numba=cfg.quads_use_numba, room_size=cfg.quads_room_size,
        obs_space_scale=cfg.quads_obs_space_scale, sim_freq=cfg.quads_sim_freq, sim_steps=cfg.quads_sim_steps
    )
